...
export default function CopyBlock({ text }) {
  ...
  return (
    <div className="relative">
      ...
      <button
        onClick={copy}
        className="absolute top-3 right-3 flex items-center gap-1.5 text-xs font-mono px-2 py-1 rounded border border-line text-dim hover:text-white transition-colors"
      >
