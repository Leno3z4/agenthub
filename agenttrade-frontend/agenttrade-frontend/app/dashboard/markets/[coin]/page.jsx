  ...
  return (
    <div>
      ...
      <div className="grid grid-cols-3 gap-3 mb-10">
        <Stat label="Funding rate" value={`${funding.toFixed(4)}%`} />
        <Stat label="Open interest" value={fmtVolume(coin.open_interest)} />
        <Stat label="24h volume" value={fmtVolume(coin.day_volume)} />
      </div>
